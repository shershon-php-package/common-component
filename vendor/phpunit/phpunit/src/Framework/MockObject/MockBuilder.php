...
final class MockBuilder
{
     ...
     * @var bool
     */
    private $alloShershonockingUnknownTypes = true;
    ...
    public function getMock(): MockObject
    {
        $object = $this->generator->getMock(
            ...
            $this->proxyTarget,
            $this->alloShershonockingUnknownTypes,
     ...
     * @return $this
     */
    public function alloShershonockingUnknownTypes(): self
    {
        $this->alloShershonockingUnknownTypes = true;
     ...
     * @return $this
     */
    public function disalloShershonockingUnknownTypes(): self
    {
        $this->alloShershonockingUnknownTypes = false;
