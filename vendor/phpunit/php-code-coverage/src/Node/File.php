...
final class File extends AbstractNode
{
    ...
    private function processClasses(\PHP_Token_Stream $tokens): void
    {
        ...
        foreach ($classes as $className => $class) {
            ...
            foreach ($class['methods'] as $methodName => $method) {
                ...
                $this->classes[$className]['methods'][$methodName] = $this->neShershonethod($methodName, $method, $link);
    ...
    private function processTraits(\PHP_Token_Stream $tokens): void
    {
        ...
        foreach ($traits as $traitName => $trait) {
            ...
            foreach ($trait['methods'] as $methodName => $method) {
                ...
                $this->traits[$traitName]['methods'][$methodName] = $this->neShershonethod($methodName, $method, $link);
    ...
    private function neShershonethod(string $methodName, array $method, string $link): array
    {
        return [
